...
/*  Интервал
    ...
    и сообщить результат на экран в следующем виде: "Число а не содержится в интервале." или "Число а
    содержится в интервале.", где  а - аргумент метода.
...
public class Solution {
    ...
    public static void checkInterval(int a) {
        ...
        else System.out.printf("Число %d не содержится в интервале.", a);
    }
}